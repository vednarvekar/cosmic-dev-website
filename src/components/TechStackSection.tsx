...
//               <span className="ml-4 font-mono text-sm">package.json</span>
//             </div>
...
//               {technologies.map((section) => (
//                 <div key={section.category} className="ml-8 mt-4">
//                   <div className="text-syntax-comment">// {section.category}</div>
//                   {section.items.map((tech) => (
//                     <div key={tech.name} className="ml-4">
...
//                     className="relative group"
//                   >
//                     <div className={`absolute inset-0 bg-gradient-to-r ${tech.color} opacity-0 group-hover:opacity-20 blur-xl rounded-lg`} />
//                     <div className="relative bg-card border rounded-lg p-2  flex gap-2 items-center">
//                       <div className="text-xl mb-2">{tech.icon}</div>
//                       <div className="font-mono font-bold text-xs">{tech.name}</div>
//                       <p className="text-xs font-mono text-muted-foreground">{tech.description}</p>
//                       <div className="mt-2 text-xs font-mono text-syntax-green">{tech.version}</div>
//                     </div>
//                   </motion.div>
//                 ))}
//               </div>
